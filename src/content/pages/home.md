...
pageTheme:
  ...
  displayFont: https://fonts.googleapis.com/css2?family=Playwrite+IN:wght@100..400&display=swap
  textFont: https://fonts.googleapis.com/css2?family=Playwrite+IN:wght@100..400&display=swap
  spacingPatterns:
    - name: Teste
      mobile: '10'
      tablet: '11'
